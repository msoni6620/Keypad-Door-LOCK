...
<b>ESP32 microcontroller:<b> Serves as the main controller, processing user input from the keypad and controlling the lock mechanism. <br>
<b>4x4 keypad:<b> Used for entering passwords and interacting with the system. <br>
<b>Electromagnetic lock:<b> Locks and unlocks the door based on the entered password under the control of the ESP32. <br>
<b>LCD display (optional):<b> Can be added to display system status, password prompts, and error messages <br>
